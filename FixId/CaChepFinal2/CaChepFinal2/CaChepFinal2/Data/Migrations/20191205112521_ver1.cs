...
namespace CaChepFinal2.Data.Migrations
{
    public partial class ver1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Phongs",
                columns: new[] { "Id", "ChuongTrinhId", "LoaiPhongId", "PhongName", "Price", "ShortDescription" },
                values: new object[,]
                {
                    { 1, 1, 1, "A101", 150000m, "notthing" },
                    { 2, 1, 1, "A102", 150000m, "notthing" },
                    { 5, 1, 1, "A105", 150000m, "notthing" },
                    { 3, 1, 2, "A103", 150000m, "notthing" },
                    { 4, 1, 2, "A104", 0m, "notthing" },
                    { 6, 1, 2, "A106", 150000m, "notthing" },
                    { 7, 1, 2, "A107", 150000m, "notthing" },
                    { 8, 1, 2, "A108", 150000m, "notthing" }
                });
