...
namespace CaChepFinal2.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChiTietDatPhongHeap>(entity =>
            {
                entity.HasNoKey();

            });
            modelBuilder.Entity<ChiTietDichVuDatPhongHeap>(entity =>
            {
                entity.HasNoKey();
            ...
            {
                entity.HasKey(e => new { e.ThoiGian, e.DatPhongId,e.PhongId});
        ...
        public virtual DbSet<ChiTietDatPhongHeap> ChiTietDatPhongHeaps { get; set; }
        public virtual DbSet<ChiTietDichVuDatPhong> ChiTietDichVuDatPhongs { get; set; }
        public virtual DbSet<ChiTietDichVuDatPhongHeap> ChiTietDichVuDatPhongHeaps { get; set; }
