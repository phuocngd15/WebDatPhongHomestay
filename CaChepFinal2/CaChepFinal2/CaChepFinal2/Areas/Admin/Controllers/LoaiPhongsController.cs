...
namespace CaChepFinal2.Areas.Admin.Controllers
{
    ...
    public class LoaiPhongsController : Controller
    {
        ...
        public IActionResult Create([Bind("Id,Name")] LoaiPhong loaiPhong)
        {
            ...
            {
                //_context.LoaiPhongs.FromSqlRaw($"execute dbo.spAddLoaiPhong {loaiPhong.Name} ");
               // _context.LoaiPhongs.FromSqlRaw($"execute dbo.spAddLoaiPhong  @Ten={loaiPhong.Name.ToString()}) ");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
           ...
           // var loaiphongName = new SqlParameter("@Ten", loaiPhong.Name);
